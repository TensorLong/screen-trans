package com.yiqun.translator.data.remote.translation.azure
...
import com.yiqun.translator.di.AzureRetrofit
    ...
    override suspend fun request(
        ...
        return try {
            ...
            val responseBody = azureService.send(
                translatorKey = ApiKeyInfo.getApiKeyAzure(context) ?: "unknown_key",
                resourceLocation = API_LOCATION,
